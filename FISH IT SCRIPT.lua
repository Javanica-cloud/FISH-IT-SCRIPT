...
WeatherTab:CreateToggle({ Name="Auto Buy Weather", CurrentValue=false, Flag="AutoBuyWeather", Callback=function(v) AutoBuyWeather=v end })
...
SettingsTab:CreateToggle({ Name="Anti Lag / Low Texture", CurrentValue=false, Flag="AntiLag", Callback=function(v)
    AntiLag=v
    if v then
